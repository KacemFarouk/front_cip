...
export class CipService {
  ...
  getcontrolling(matricule) {
    ...
    return this.http.get("http://localhost/cip/getUserByMatricule.php?matricule=" + matricule)

  }


  getcipcontrolling(matricule) {
    return this.http.get("http://localhost/cip/getCipByControllingAndEtat.php?controlling=" + matricule + "&etat=encours")
  }


  getcipheadofcontrolling() {
    return this.http.get("http://localhost/cip/getCipByValeurGainAndEtat.php?valeurGain=500&etat=valid2")
  }


  getcipdirecteur() {
    return this.http.get("http://localhost/cip/getCipByValeurGainAndEtat.php?valeurGain=1000&etat=valid2")
  }

  vadationcontrolling(gain, point) {

    return this.http.get("http://localhost/cip/updateValeurGain.php?valeurGain=4448&points=" + point + "&numero=" + gain)
  }

  getCipByMatricule(matricule) {
    return this.http.get("http://localhost/cip/getCipByMatricule.php?matricule=" + matricule)
